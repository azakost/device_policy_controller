...
abstract class DevicePolicyControllerPlatform extends PlatformInterface {
  ...
  static DevicePolicyControllerPlatform _instance = DevicePolicyControllerPlatformImpl();
  ...
  void handleBootCompleted(FutureOr<dynamic> Function(DevicePolicyController dpc) handler);
